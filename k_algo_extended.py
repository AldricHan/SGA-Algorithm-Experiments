...
#     print eps
    ...
    for i in range(3):
        for j in range(i+1, 4):
            ...
            if (emp_cov[pair1[0], pair2[0]]*emp_cov[pair1[1], pair2[1]])/ (emp_cov[pair1[0], pair2[1]]*emp_cov[pair1[1], pair2[0]]) > eps and\
            (emp_cov[pair1[0], pair2[0]]*emp_cov[pair1[1], pair2[1]])/(emp_cov[pair1[0], pair1[1]]*emp_cov[pair2[0], pair2[1]])<eps:                
                non_star = True
                fin_pair1[:] = pair1[:]
                fin_pair2[:] = pair2[:]
    if non_star == True:
